...
/**
 * Handler for the {@link ValueGenerator} annotation when applied to a field/property of a persistable class.
 */
public class ValueGeneratorHandler implements MemberAnnotationHandler
{
    public void processMemberAnnotation(AnnotationObject ann, AbstractMemberMetaData mmd, ClassLoaderResolver clr)
    {
        ...
        String strategy = (String)annotationValues.get("strategy");
        mmd.setValueStrategy(strategy);
    }
}