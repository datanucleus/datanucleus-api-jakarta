...
/**
 * Handler for the {@link ColumnPosition} annotation when applied to a field/property of a persistable class.
 */
public class ColumnPositionHandler implements MemberAnnotationHandler
{
    public void processMemberAnnotation(AnnotationObject ann, AbstractMemberMetaData mmd, ClassLoaderResolver clr)
    {
        ...
        int position = (Integer)annotationValues.get("value");
