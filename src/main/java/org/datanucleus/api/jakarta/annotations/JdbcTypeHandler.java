...
/**
 * Handler for the {@link JdbcType} annotation when applied to a field/property of a persistable class.
 */
public class JdbcTypeHandler implements MemberAnnotationHandler
{
