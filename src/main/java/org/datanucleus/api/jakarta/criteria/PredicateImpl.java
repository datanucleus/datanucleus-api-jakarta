...
public class PredicateImpl extends ExpressionImpl<Boolean> implements Predicate
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Predicate#not()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Predicate#getExpressions()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Predicate#getOperator()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Predicate#isNegated()
     */
