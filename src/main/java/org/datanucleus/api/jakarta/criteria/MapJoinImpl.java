...
public class MapJoinImpl<Z, K, V> extends PluralJoinImpl<Z, java.util.Map<K, V>, V> implements MapJoin<Z, K, V>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.MapJoin#entry()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.MapJoin#joinKey()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.MapJoin#joinKey(jakarta.persistence.criteria.JoinType)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.MapJoin#key()
     */
    public Path<K> key()
    {
        // TODO Implement this
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.MapJoin#value()
     */
    public Path<V> value()
    {
        // TODO Implement this
