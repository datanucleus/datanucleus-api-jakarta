...
public class SimpleCaseExpressionImpl<C, R> extends ExpressionImpl<R> implements SimpleCase<C, R>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaBuilder.SimpleCase#getExpression()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaBuilder.SimpleCase#otherwise(java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaBuilder.SimpleCase#otherwise(jakarta.persistence.criteria.Expression)
     */
    @Override
