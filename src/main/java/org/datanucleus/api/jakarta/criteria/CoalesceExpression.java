...
public class CoalesceExpression<T> extends ExpressionImpl<T> implements Coalesce<T>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.QueryBuilder.Coalesce#value(jakarta.persistence.criteria.Expression)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.QueryBuilder.Coalesce#value(java.lang.Object)
     */
