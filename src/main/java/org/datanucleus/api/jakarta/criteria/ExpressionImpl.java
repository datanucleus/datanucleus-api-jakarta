...
public class ExpressionImpl<T> implements Expression<T>, Serializable
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#as(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#in(java.util.Collection)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#in(jakarta.persistence.criteria.Expression<?>[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#in(java.lang.Object[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#isNotNull()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Expression#isNull()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Selection#alias(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Selection#getCompoundSelectionItems()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.Selection#isCompoundSelection()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.TupleElement#getAlias()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.TupleElement#getJavaType()
     */
