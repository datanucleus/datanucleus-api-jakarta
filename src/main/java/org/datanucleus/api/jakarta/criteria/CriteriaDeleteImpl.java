...
public class CriteriaDeleteImpl<T> implements CriteriaDelete<T>, Serializable
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaDelete#from(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaDelete#from(jakarta.persistence.metamodel.EntityType)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaDelete#getRoot()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaDelete#where(jakarta.persistence.criteria.Expression)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaDelete#where(jakarta.persistence.criteria.Predicate[])
     */
