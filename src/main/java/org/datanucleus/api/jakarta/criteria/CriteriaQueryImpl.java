...
public class CriteriaQueryImpl<T> implements CriteriaQuery<T>, Serializable
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#distinct(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#select(jakarta.persistence.criteria.Selection)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#multiselect(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#multiselect(jakarta.persistence.criteria.Selection<?>[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.AbstractQuery#getSelection()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#where(jakarta.persistence.criteria.Expression)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#where(jakarta.persistence.criteria.Predicate[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#groupBy(jakarta.persistence.criteria.Expression<?>[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#groupBy(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#having(jakarta.persistence.criteria.Expression)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#having(jakarta.persistence.criteria.Predicate[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#getOrderList()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#orderBy(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#orderBy(jakarta.persistence.criteria.Order[])
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.criteria.CriteriaQuery#getParameters()
     */
