 ...
 * Implements DefaultHandler and handles the extracting of MetaData for Jakarta Persistence from the XML elements/attributes. 
 ...
 * </P>
 */
public class JakartaXmlMetaDataHandler extends AbstractXmlMetaDataHandler
{
     ...
     */
    public JakartaXmlMetaDataHandler(MetaDataManager mgr, String filename, EntityResolver resolver)
    {
        ...
        try
        {
            ...
            else if (localName.equals("pre-persist"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PrePersist", getAttr(attrs, "method-name"));
                }
                else
                {
            ...
            else if (localName.equals("post-persist"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PostPersist", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
            ...
            else if (localName.equals("pre-remove"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PreRemove", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
            ...
            else if (localName.equals("post-remove"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PostRemove", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
            ...
            else if (localName.equals("pre-update"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PreUpdate", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
            ...
            else if (localName.equals("post-update"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PostUpdate", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
            ...
            else if (localName.equals("post-load"))
            {
                ...
                if (md instanceof AbstractClassMetaData)
                {
                    ...
                    elmd.addCallback("jakarta.persistence.PostLoad", getAttr(attrs, "method-name"));
                }
                else
                {
                    // Specified at <entity-listener>
