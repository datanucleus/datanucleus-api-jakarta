...
public class IdentifiableTypeImpl<X> extends ManagedTypeImpl<X> implements IdentifiableType<X>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getDeclaredId(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getDeclaredVersion(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getId(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getIdClassAttributes()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getIdType()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getSupertype()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#getVersion(java.lang.Class)
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#hasSingleIdAttribute()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.IdentifiableType#hasVersionAttribute()
     */
