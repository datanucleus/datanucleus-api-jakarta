...
public class SingularAttributeImpl<X, T> extends AttributeImpl<X, T> implements SingularAttribute<X, T>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.SingularAttribute#isId()
     */
    public boolean isId()
    {
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.SingularAttribute#isOptional()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.SingularAttribute#isVersion()
     */
