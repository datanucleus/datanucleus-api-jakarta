...
public class AttributeImpl<X, Y> implements Attribute<X, Y>
{
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#getDeclaringType()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#getJavaMember()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#getJavaType()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#getName()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#getPersistentAttributeType()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#isAssociation()
     */
    ...
    /* (non-Javadoc)
     * @see jakarta.persistence.metamodel.Attribute#isCollection()
     */
